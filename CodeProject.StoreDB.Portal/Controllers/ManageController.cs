namespace CodeProject.StoreDB.Portal.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        /// The Index
        /// </summary>
        /// <param name="message">The message<see cref="ManageMessageId?"/></param>
        ...
        /// The RemoveLogin
        /// </summary>
        /// <param name="loginProvider">The loginProvider<see cref="string"/></param>
        /// <param name="providerKey">The providerKey<see cref="string"/></param>
        /// <returns>The <see cref="Task{ActionResult}"/></returns>
        [HttpPost]
        ...
        /// The SetPassword
        /// </summary>
        /// <param name="model">The model<see cref="SetPasswordViewModel"/></param>
        /// <returns>The <see cref="Task{ActionResult}"/></returns>
        [HttpPost]
        [ValidateAntiForgeryToken]
